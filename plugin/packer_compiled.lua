...
_G.packer_plugins = {
  ...
  ["indent-blankline.nvim"] = {
    ...
    loaded = true,
    path = "/Users/adam/.local/share/nvim/site/pack/packer/start/indent-blankline.nvim",
  ...
  ["nvim-ts-rainbow"] = {
    loaded = true,
    path = "/Users/adam/.local/share/nvim/site/pack/packer/start/nvim-ts-rainbow",
  ...
  ["sqls.nvim"] = {
    loaded = true,
    path = "/Users/adam/.local/share/nvim/site/pack/packer/start/sqls.nvim",
